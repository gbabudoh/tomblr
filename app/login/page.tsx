...
import { LogIn, Mail, Lock, ArrowRight, ShieldCheck, CheckCircle2 } from "lucide-react";
          ...
          <div className="bg-white/50 backdrop-blur-xl p-10 rounded-[2.5rem] border border-accent/20 shadow-2xl">
            ...
            {showSuccess && (
              <motion.div
                ...
                className="mb-6 p-4 bg-primary/20 text-foreground rounded-xl text-sm border border-primary/30 flex items-center gap-3"
              >
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="••••••"
                    required
                    className="w-full pl-12 pr-4 py-4 bg-background border border-accent/10 rounded-2xl text-foreground focus:outline-none focus:ring-2 focus:ring-primary transition-all tracking-[0.5em] font-mono"
                  />
                </div>
              </div>
            ...
            <p className="mt-8 text-center text-sm text-foreground/40 text-wrap">
              Don&apos;t have an account?{" "}
               <Link href="/access" className="text-foreground font-bold hover:underline cursor-pointer">Get Access</Link>
            </p>
          </div>
        </motion.div>
      </main>
